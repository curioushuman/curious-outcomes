...
describe('ApiAdminStack : findOne', () => {
  let app: cdk.App;
  ...
  describe('/courses/{eventId}', () => {
    const resourceParentRegex = 'apiadmincourses[A-Z0-9]+';
    const resourceIdRegex = 'apiadmincoursesexternalId[A-Z0-9]+';
    const responseMethodSuccessModelRegex =
      'apiadminresponsemodelcourseresponsedto[A-Z0-9]+';
