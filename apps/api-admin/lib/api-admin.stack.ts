...
export class ApiAdminStack extends cdk.Stack {
  constructor(scope: Construct, id: string, props?: cdk.StackProps) {
    ...
    /**
     * Resources for the /courses endpoint
     */
    /**
    ...
    coursesHookTypeAndId.addMethod('GET');
    // coursesHookTypeAndId.addMethod('GET',
    ...
    //       },
    //       // NOTE: the following source has an example of using VTL:foreach to include
    //       //       the params of the original request, in the JSON of the message.
    //       //       https://medium.com/@gmalaguti/aws-api-gateway-integration-treks-sns-d47543cb0413
    //       //       VTL: https://velocity.apache.org/engine/devel/vtl-reference.html
    //       requestTemplates: {
    //         'application/json':
